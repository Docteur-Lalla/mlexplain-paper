...
with one for a different language.
...
% Difference entre les constructeurs, raison principale de la traduction à la
% main
...
context. A monad typically take the form of a type constructor. It provides the
following functions:
